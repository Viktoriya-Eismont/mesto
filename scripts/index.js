const profileEditName = document.querySelector('.profile_edit_name');
const profileInfo = document.querySelector('.profile__info');
const popupTypeProfile = document.querySelector('.popup_type_profile');
const buttonClosePopupEditProfile = popupTypeProfile.querySelector('.popup__close');
const inputName = popupTypeProfile.querySelector('.popup_type_name');
const inputAbout = popupTypeProfile.querySelector('.popup_type_about');
